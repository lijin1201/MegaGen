...
class BasicUNetDS(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        out_ds3 = self.deep_head3(u3)
        out_ds2 = self.deep_head2(u2)
        out_ds1 = self.deep_head1(u1)

        out_ds3 = F.interpolate(out_ds3, size=x.shape[2:], mode="bilinear", align_corners=False)
        out_ds2 = F.interpolate(out_ds2, size=x.shape[2:], mode="bilinear", align_corners=False)
